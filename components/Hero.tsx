    ...
    <section id="hero" className={styles.hero}>
      <div className={`container ${styles.inner}`}>
        ...
        <div className={styles.topcontact}>
          <b>Jaxton Wright</b>&nbsp;&middot;&nbsp; jaxtonwright11@berkeley.edu &nbsp;&middot;&nbsp; calendly.com/jaxtonwright
        </div>
        ...
        >
          <span className="eyebrow">What Meridian is</span>
          ...
          <div id="waitlist" className={styles.waitlist}>
            <div className={styles.waitlistHead}>
              <span className="eyebrow" style={{ marginBottom: 0 }}>Join the waitlist</span>
            ...
            <a href="#the-day" className={styles.seeDay}>What the day looks like</a>
          </div>
        </motion.div>
      </div>
    </section>
